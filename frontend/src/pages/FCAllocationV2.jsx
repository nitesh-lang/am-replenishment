        ...
        <div className="bg-white rounded-lg border border-slate-200 shadow-sm p-3 mb-3">
          <div className="grid grid-cols-12 gap-3 items-end">
            ...
            <div className="col-span-2 flex items-center gap-2 justify-end">
              ...
              {(asinTypes.length > 0 || brands.length > 1 || categories.length > 0 || listingStatuses.length > 0) && !isFossil && (
                <button
          ...
          {(categories.length > 0 || listingStatuses.length > 0) && !isFossil && filtersOpen && (
                          ...
                          if (colId === "model") {
                            ...
                            content = (
                              <span className="inline-flex items-center gap-1 font-mono text-xs text-slate-700">
                                ...
                                {r.is_eol && (
                                  <span
                                    title="CB EOL — Cambium has marked this SKU CB=No in CB Replenishment_Master. Kept visible on purpose; send qty is forced to 0 so it cannot be pushed."
